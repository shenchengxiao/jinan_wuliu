...
<style type="text/css">
	...
	.btnDial{width:163px; height:39px; background:url('./image/Uc3_p1_24.jpg');} <!--拨号-->
	
</style>
</head>
<!---->
<object id="UsbPhone"  border=1 width=1 height=1
...
function ceshi(){
	...
	del.style.background = "url('./image/Uc3_p1_21.jpg')";
...
function voip()
{
	document.getElementById("btnVOIPIO").style.background="url(./image/Uc3_p1_1.jpg)";
}
