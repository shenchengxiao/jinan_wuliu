                    ...
                    <div class="portlet box grey">
                        ...
                        <div class="box">
                            <div class="portlet-body no-more-tables">
                                <table class="table-bordered table-striped table-condensed cf" id="blackword_List">
                                    <thead class="cf">
                                    <tr>
                                        <th>黑名词</th>
                                        <th>创建时间</th>
...
<!-- endbuild -->
<script src="${pageContext.request.contextPath}/js/blackword/blackword.js"></script>
</body>
</html>
