                            ...
                            <form id="edit_user_info_form" class="form-horizontal">
                                ...
                                <fieldset>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="span4" data-toggle="distpicker">
                                            <select name="province" id="province_id" class="m-wrap span4" ></select>
                                            <select name="city" id="city_id" class="m-wrap span4" ></select>
                                            <select name="county" id="county_id" class="m-wrap span4"></select>
                                        </div>
                                    </div>
                                ...
                                <fieldset>
                                    <div class="form-actions" align="center">
                                        <a href="javascript:;" class="btn green" id="btn_editUserInfo">提交</a>
...
<script src="${pageContext.request.contextPath}/js/background/user_edit.js"></script>
</body>
</html>