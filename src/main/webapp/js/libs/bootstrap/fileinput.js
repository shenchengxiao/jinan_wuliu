...
(function (factory) {
    ...
    defaultFileActionSettings = {
        ...
        showZoom: true,
        showDrag: true,
        removeIcon: '<i class="glyphicon icon-trash text-danger"></i>',
        removeClass: 'btn btn-xs btn-default',
        removeTitle: 'Remove file',
        uploadIcon: '<i class="glyphicon icon-upload text-info"></i>',
        uploadClass: 'btn btn-xs btn-default',
        uploadTitle: 'Upload file',
        zoomIcon: '<i class="glyphicon icon-zoom-in"></i>',
        zoomClass: 'btn btn-xs btn-default',
        zoomTitle: 'View Details',
        dragIcon: '<i class="glyphicon icon-menu-hamburger"></i>',
        dragClass: 'text-info',
        dragTitle: 'Move / Rearrange',
        dragSettings: {},
        indicatorNew: '<i class="glyphicon icon-hand-down text-warning"></i>',
        indicatorSuccess: '<i class="glyphicon icon-ok-sign text-success"></i>',
        indicatorError: '<i class="glyphicon icon-exclamation-sign text-danger"></i>',
        indicatorLoading: '<i class="glyphicon icon-hand-up text-muted"></i>',
    ...
    tFileIcon = '<i class="glyphicon icon-file kv-caption-icon"></i>';
    tCaption = '<div tabindex="500" class="form-control1 file-caption1 {class}">\n' +
    ...
    $.fn.fileinput.defaults = {
        ...
        previewZoomButtonIcons: {
            prev: '<i class="glyphicon icon-triangle-left"></i>',
            next: '<i class="glyphicon icon-triangle-right"></i>',
            toggleheader: '<i class="glyphicon icon-resize-vertical"></i>',
            fullscreen: '<i class="glyphicon icon-fullscreen"></i>',
            borderless: '<i class="glyphicon icon-resize-full"></i>',
            close: '<i class="glyphicon icon-remove"></i>'
        },
        ...
        browseIcon: '<i class="glyphicon icon-folder-open"></i>&nbsp;',
        browseClass: 'btn purple',
        removeIcon: '<i class="glyphicon icon-trash"></i>',
        removeClass: 'btn btn-default',
        cancelIcon: '<i class="glyphicon icon-ban-circle"></i>',
        cancelClass: 'btn btn-default',
        uploadIcon: '<i class="glyphicon icon-upload"></i>',
