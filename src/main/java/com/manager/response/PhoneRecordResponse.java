...
public class PhoneRecordResponse implements Serializable{
	/**
	 * 
	 */
	private static final long serialVersionUID = 5522216026246712470L;
	...
	public String toString() {
		return "PhoneRecordResponse [rId=" + rId + ", serviceNum=" + serviceNum + ", inPhone=" + inPhone + ", custId="
				+ custId + ", inTime=" + inTime + ", outTime=" + outTime + ", createTime=" + createTime
				+ ", updateTime=" + updateTime + ", isAnswer=" + isAnswer + ", isHang=" + isHang + "]";
	}
